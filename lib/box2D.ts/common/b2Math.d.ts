...
export declare function b2Abs(x: number): number;
export declare function b2AbsInt(x: number): number;
export declare function b2Min(a: number, b: number): number;
export declare function b2Max(a: number, b: number): number;
export declare function b2MinInt(a: number, b: number): number;
export declare function b2MaxInt(a: number, b: number): number;
export declare function b2Clamp(a: number, lo: number, hi: number): number;
export declare function b2ClampInt(a: number, lo: number, hi: number): number;
